...
The code, the result artefacts and the LaTeX source of this thesis are at
\url{https://github.com/W00DSRULES/bio-inspired-foveation-in-dg3}; Appendix~\ref{app:impl} names the module or
script behind each step.
